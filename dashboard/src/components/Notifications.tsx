...
export const KINDS = {
  ...
  account_daily_due: { label: "تحديث دوري مطلوب", icon: CalendarClock, tone: "bg-danger-light text-destructive" },
  group_daily_due: { label: "حسابات تجاوزت موعد التحديث", icon: CalendarX2, tone: "bg-danger-light text-destructive" },
