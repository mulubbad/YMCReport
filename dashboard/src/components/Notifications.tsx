...
export const KINDS = {
  ...
  account_daily_due: { label: "تحديث يومي مطلوب", icon: CalendarClock, tone: "bg-danger-light text-destructive" },
  group_daily_due: { label: "حسابات لم تُحدَّث اليوم", icon: CalendarX2, tone: "bg-danger-light text-destructive" },
